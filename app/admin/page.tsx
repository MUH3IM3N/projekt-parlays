...
import { LogOut, Trash2, PlusCircle, MinusCircle, ShieldCheck, Eye } from "lucide-react";
...
export default function AdminPage() {
  ...
  // Login Handler (Demo, bitte Backend!)
  ...
  // Leg-Feld-Änderung (pro Leg/Spiel)
  ...
  // Tipp-Top-Level ändern (Sport, Combo, Status)
  const handleChange = (
